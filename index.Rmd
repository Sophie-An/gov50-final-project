...
## Data
The analyses of this cross-sectional study rely on three data sets. The primary one is The Nation’s Report Card published by the National Assessment of Educational Progress. In particular, the 2022 4th grade mathematics assessment by state and eligibility for free lunch. Each child’s score ranges from 0 to 500 with a national average of 231 points. Qualifying for free lunch in a sense measures the difference in scores by income level. The second data set, percentage of 2020 election votes in support of the Democratic Party by state, comes from the Massachusetts Institute of Technology Election Data and Science Lab. The percentages are of all voters, not all people eligible to vote. Poverty rates, the final data set, are pulled from the 2020 U.S. Census data. The poverty percentages are of people aged 5-17, the primary age demographic in schools by state.
To calculate the difference in math scores between students who didn’t and did qualify for free lunch, I originally subtracted the average score of students who qualify for free lunch from the average of those who do not to find absolute difference in scores. But, the relative difference in scores better accounts for state to state differences that make the difference in scores seem larger. This is calculated by dividing the absolute score difference by the average score of students not eligible for free lunch.The relative difference in scores accounts for how a 10 point difference in a state with an average score of 271 and a 8 point difference in a state with an average score of 217 are equivalent in the percent difference.
...
The additional bivariate regressions are between percent of democrat votes by state and test scores (not difference in test scores) for students eligible for free lunch and students not eligible. For students eligible for free lunch, a one point increase in democratic vote is associated with a 0.137 decrease in scores. Students who qualify for free lunch in more democratic states have lower scores. This estimate has a p-value of 0.0329. Using the alpha level of 0.05, this result is statistically significant. For students who do not qualify for free lunch, a one percent increase in democrat votes is associated with a 0.0479 point increase in scores. However, the p-value of this estimate was only 0.469 and thus not significant at the alpha level of 0.05. If the result was statistically significant, it would suggest that students who don’t receive free lunch perform higher in more democratic states.
